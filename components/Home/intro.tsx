...
const IntroSection = () => {
    return (
        <div className="w-full bg-black px-4 py-4  gap- flex flex-col">
            <div className="flex flex-col justify-center items-center relative py-4">
                ...
                <span className="text-white mt-5 text-xl font-bold">Cafe in Frankfurt</span>
                <div className="bg-gray-600 hover:bg-gray-400 my-5 px-6 py-2 z-10 rounded-lg">
