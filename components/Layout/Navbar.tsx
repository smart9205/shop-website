            ...
            <header className="bg-black sticky top-0 z-30 w-full px-2 md:py-0  py-4  sm:px-4 shadow-xl border-b-gray-300 border-b-4">
                <div className="flex items-center justify-between mx-auto max-w-7xl">
                    <div className='flex justify-center items-center gap-2'>
                        ...
                        <a target="_blank" href="https://maps.app.goo.gl/cRLEXB9Qa1EHt6dc9" rel="noopener noreferrer" className='max-w-[260px] md:max-w-full'>
                    ...
                    <div className="flex items-center space-x-1">
                        <ul className="hidden space-x-2 lg:inline-flex">
                            ...
                            <li>
                                <a target="_blank" href="https://maps.app.goo.gl/cRLEXB9Qa1EHt6dc9" rel="noopener noreferrer" className="px-2 py-2 font-semibold text-white rounded">
                                    <div className="flex items-center justify-center gap-4 px-3 m-0">
